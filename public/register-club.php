...
<head>
    ...
    <title>INSAT PULSE - Register Club</title>
    <link rel="stylesheet" href="assets/css/registerClub.css">
</head>
<body>
    <div class="container">
        <div class="left-section">
            <div class="form-container">
                <div class="logo">
                    <img src="assets/images/logo_cropped.png" alt="INSAT PULSE Logo" class="logo-img">
                </div>
                <h2 class="form-title">Request a club account</h2>
                <form class="registration-form" action="actions/do-register-club.php" method="post">
                    <div class="form-group">
                        <label for="clubname">Club's name</label>
